...
gulp.task("clean", () =>
  gulp
    .src([`${config.base.public}/dist/css`, `${config.base.public}/dist/js`], {
      read: false,
    })
    .pipe(clean())
);
...
gulp.task("styles", () => {
  ...
  gulp
    ...
    .pipe(gulp.dest(`${config.base.public}/dist/css/`));
});
...
gulp.task("scripts", (cb) => {
  if (config.scripts.length) {
    config.scripts.forEach((filePath) => {
      ...
      const dest = `${config.base.public}/dist/js/${formattedPath.replace(
        ".js",
        ".min.js"
      )}`;
...
gulp.task("images", (cb) => {
  ...
  gulp
    ...
    .pipe(gulp.dest(`${config.base.public}/dist/img`))
    .on("end", () => cb());
});
